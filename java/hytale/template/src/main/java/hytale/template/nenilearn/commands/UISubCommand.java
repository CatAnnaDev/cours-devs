...
import hytale.template.nenilearn.ui.NeniLearnDashboardUI;

import javax.annotation.Nonnull;

/**
 * /neni ui - Open the plugin dashboard UI
 *
...
public class UISubCommand extends AbstractPlayerCommand {
    ...
    protected void execute(
        ...
        try {
            ...
            NeniLearnDashboardUI dashboardPage = new NeniLearnDashboardUI(playerRef);
