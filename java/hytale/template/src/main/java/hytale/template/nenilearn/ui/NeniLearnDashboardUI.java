package hytale.template.nenilearn.ui;
...
/**
 * NeniLearn Dashboard UI
 *
 * A simple interactive dashboard page showing plugin information
 * with refresh and close buttons.
 */
public class NeniLearnDashboardUI extends InteractiveCustomUIPage<NeniLearnDashboardUI.UIEventData> {

    // Path relative to Common/UI/Custom/
    public static final String LAYOUT = "nenilearn/Dashboard.ui";

    private final PlayerRef playerRef;
    private int refreshCount = 0;

    public NeniLearnDashboardUI(@Nonnull PlayerRef playerRef) {
