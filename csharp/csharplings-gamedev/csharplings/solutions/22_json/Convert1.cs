...
public static class JsonConvert
{
    ...
    private static readonly JsonSerializerOptions Indented = new(Settings) { WriteIndented = true };

    public static string SerializeObject(object value) =>
        JsonSerializer.Serialize(value, value?.GetType() ?? typeof(object), Settings);
