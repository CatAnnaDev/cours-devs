...
public static class Culture1
{
    ...
    public static string WriteSetting(float value) => value.ToString("R", CultureInfo.InvariantCulture);
    ...
    public static Dictionary<string, int> BuildIndex() => new(StringComparer.Ordinal);
