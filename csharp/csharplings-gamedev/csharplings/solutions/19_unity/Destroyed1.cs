...
public static class Destroyed1
{
    ...
    public static bool IsMissing(UnityObject target) => target == null;

    public static bool IsNullReference(UnityObject target) => target is null;
