...
public static class Replay1
{
    ...
    public static IEnumerable<int> Alive(List<int> healths) => healths.Where(IsAlive);

    public static List<int> AliveOnce(List<int> healths) => healths.Where(IsAlive).ToList();
