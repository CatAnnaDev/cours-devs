...
public static class Sets1
{
    ...
    public static List<string> NewlyUnlocked(List<string> now, List<string> before) =>
        now.Where(unlock => !before.Contains(unlock)).ToList();

    public static List<string> Common(List<string> left, List<string> right) => Todo.Value<List<string>>();

    public static List<string> All(List<string> left, List<string> right) => Todo.Value<List<string>>();
