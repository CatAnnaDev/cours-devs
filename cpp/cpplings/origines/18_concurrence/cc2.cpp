...
constexpr std::memory_order ORDRE_DE_LA_POSE = std::memory_order_relaxed;
constexpr std::memory_order ORDRE_DE_LA_PRISE = std::memory_order_relaxed;
...
long recevoir_le_temoin(int manche) {
    const long gravure = gravure_du_temoin.load(std::memory_order_relaxed);
