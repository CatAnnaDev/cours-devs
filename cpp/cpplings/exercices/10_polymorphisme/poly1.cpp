...
struct Forme {
    ...
    const char *nom() const { return "forme"; }
};
...
struct Cercle : Forme {
    ...
    double aire() const { return std::numbers::pi * rayon * rayon; }
    const char *nom() const { return "cercle"; }
};
...
struct Carre : Forme {
    ...
    double aire() const { return cote * cote; }
    const char *nom() const { return "carre"; }
};
